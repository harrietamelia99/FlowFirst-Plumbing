    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a
            href="#contact"
            className="btn-shimmer inline-flex items-center gap-2.5 px-8 py-4 font-700 rounded-xl shadow-xl hover:opacity-90 hover:shadow-2xl transition-all duration-200 text-base group"
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 px-8 py-4 border-2 border-white/20 hover:border-[#9ee7f0]/60 text-white font-700 rounded-xl hover:bg-white/5 transition-all duration-200 text-base"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-4 text-gray-400 hover:text-gray-200 font-600 transition-colors duration-200 text-sm"
          >
